...
class FeatureSelector:
    ...
    def improved_hier_cluster_feature_selection(self, corr_threshold=0.9, vif_threshold=10.0, alpha=0.5):
        ...
        The correlation threshold used in hierarchical clustering (default is 0.9)

        vif_threshold : float, optional
            The VIF threshold for feature removal (default is 10.0)
         alpha : float, optional
            The weight for variance in the scoring function (default is 0.5)
